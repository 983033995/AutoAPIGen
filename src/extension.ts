...
export function activate(context: vscode.ExtensionContext) {
    try {
		...
		// 启用 AI 工具支持 → 打开文档页（安装 CLI + 注入 Skill 的详细教程）
		const enableAISupportDisposable = vscode.commands.registerCommand('AutoAPIGen.enableAISupport', () => {
			vscode.env.openExternal(vscode.Uri.parse('https://doc.du-ai.cn/guide/ai-support'))
		})
