            ...
            >
              <template #title="nodeData">
                <div
                  ...
                  :style="{ cursor: nodeData.type === 'apiDetailFolder' ? 'default' : 'pointer' }"
                  :ref="(el: Element) => (treeItemRef[nodeData.key.replace('.', '_')] = el)"
                >
                  ...
                  <span
                    v-else
                    :class="apiType[nodeData.api.method as keyof ApiTypeMap].class"
                    class="text-lg font-bold"
                    :style="{ color: apiType[nodeData.api.method as keyof ApiTypeMap].color }"
                  ></span>
                  ...
                  <div class="cursor-pointer w-8 h-5" v-if="nodeData.type !== 'doc'">
                    <a-dropdown
                      trigger="hover"
                      :popup-container="treeItemRef[nodeData.key.replace('.', '_')]"
                      @select="(val: string) => handleSelectOperate(val, nodeData)"
                    >
